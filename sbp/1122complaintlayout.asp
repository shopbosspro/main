...
function findPos(obj,comid) {
  ...
  if(navigator.appName == "Microsoft Internet Explorer"){
	  document.getElementById("drop"+comid).style.left = curleft-38
	  document.getElementById("drop"+comid).style.top = curtop+26
	  document.getElementById("drop"+comid).style.display = 'inline-block'
  }else{
	  document.getElementById("drop"+comid).style.left = curleft+6
	  document.getElementById("drop"+comid).style.top = curtop+17
	  document.getElementById("drop"+comid).style.display = 'inline-block'
  }
...
<%
stmt = "select * from company where shopid = '" & request.cookies("shopid") & "'"
...
%>
			...
			<%
			if request.cookies("shopid") = "1055" then
			%>
...
function getcolor()
  ccstmt = "select * from parts where shopid = '" & request.cookies("shopid") & "' and roid = " & roid & " and complaintid = " & comid
  ...
  'check for labor
  llstmt = "select * from labor where shopid = '" & request.cookies("shopid") & "' and roid = " & roid & " and complaintid = " & comid
  ...
  'check for sublet
  ssstmt = "select * from sublet where deleted = 'no' and shopid = '" & request.cookies("shopid") & "' and roid = " & roid & " and complaintid = " & comid
...
'get complaints
roid = request("roid")
stmt = "select complaintid from complaints where cstatus = 'no' and shopid = '" & request.cookies("shopid") & "' and roid = " & roid
...
stmt = "select * from complaints where cstatus = 'no' and shopid = '" & request.cookies("shopid") & "' and roid = " & roid & " order by displayorder"
set comrs = con.execute(stmt)
cntr = 1
if not comrs.eof then
  comrs.movefirst
...
<table background="newimages/wipheader.jpg" bgcolor=<%=mbgc%> width="100%" cellspacing="0" bordercolor="#99CCFF" cellpadding="2" style="border-collapse: collapse">
  <tr>
    <td style="width: 90%" class="style2223"><font size="2"><font color="#FFFFFF">#<%=comrs("displayorder")%>
	...
	%>
      ...
      Tech Story: <%=left(ucase(comrs("techreport")),80)%> <span onclick="document.body.onunload='';saveAll('techreport.asp?comrootid=<%=comrootid%>&comid=<%=comid%>&')" style="color:yellow;cursor:pointer">[more]</span></font>
	...
	%>
	<img style="cursor:pointer" onclick="changePos('<%=comrs("id")%>','<%=comrs("displayorder")%>','up','<%=comrs("roid")%>')" alt="" height="30" src="newimages/uparrow.png" width="30">
	<%
	end if
	if cntr >= 1 and cntr < comc then
	%>
	<img style="cursor:pointer" onclick="changePos('<%=comrs("id")%>','<%=comrs("displayorder")%>','down','<%=comrs("roid")%>')"  alt="" height="30" src="newimages/downarrow.png" width="30">
	<%
	end if
	%>
	</td>
  ...
  <%
  'get parts
  cstmt = "select * from parts where shopid = '" & request.cookies("shopid") & "' and roid = " & roid & " and complaintid = " & comid
  addbut = "no"
  ...
  response.write "<input style='width:65px;' type='button' value='Parts' class='abuts' onclick=document.body.onunload='',saveAll('addpart1.asp?comid=" & comid & "&','part','','','')>"
  response.write "<input style='width:65px;' type='button' value='Labor' class='abuts' onclick=document.body.onunload='';saveAll('addlabor.asp?comid=" & comid & "&','labor','','','')>"
  response.write "<input style='width:65px;' type='button' value='Sublet' class='abuts' onclick=document.body.onunload='';saveAll('addsublet.asp?comid=" & comid & "&','sublet','','','')>"
  response.write "<input style='width:85px;' type='button' value='Canned Job' style='width:100px;' class='abuts' onclick=document.body.onunload='';saveAll('addcannedjobtoro.asp?comid=" & comid & "&','canned','','','')>"
  response.write "<input style='width:85px;' class='abuts' onclick=document.body.onunload='';saveAll('techreport.asp?comrootid=" & comrootid & "&comid=" & comid &"&','','','','') style='font-size:12px;height:24px;width:100px;' type='button' value='Tech Story' name='ts'>"
  %>
  &nbsp;<input onclick="findPos(this,'<%=comrs("complaintid")%>')" id="dropbutton<%=comrs("complaintid")%>" type='button' value='Status:<%=comrs("acceptdecline")%>' style='cursor:pointer;width:150px; font-weight:bold<%=itemcolor%>' class='abuts' onclick=document.body.onunload='';saveAll('addcannedjobtoro.asp?comid=" & comid & "&','canned','','','')>
  <%
  ...
  <ul id="drop<%=comrs("complaintid")%>" style="list-style-type:none;display:none;position:absolute;width:130px;background-color:silver;z-index:1001;font-weight:bold; left: 0px; top: 0px; padding:5px;border:thin gray solid" id="test">
    <li onclick="document.body.onunload='';document.theform.action='savero.asp?comid=<%=comrs("complaintid")%>&comstat=Pending';saveAll('ro.asp?a=n','','','','','')" onmouseout="this.style.backgroundColor='silver';this.style.color='black'" onmouseover="this.style.backgroundColor='green';this.style.color='white'" style="padding:5px;cursor:pointer">Pending</li>
  	<li onclick="declineItem('<%=comrs("complaintid")%>')" onmouseout="this.style.backgroundColor='silver';this.style.color='black'" onmouseover="this.style.backgroundColor='green';this.style.color='white'" style="padding:5px;cursor:pointer">Declined</li>
  	<li onclick="document.body.onunload='';document.theform.action='savero.asp?comid=<%=comrs("complaintid")%>&comstat=Parts Ordered';saveAll('ro.asp?a=n','','','','','')" onmouseout="this.style.backgroundColor='silver';this.style.color='black'" onmouseover="this.style.backgroundColor='green';this.style.color='white'" style="padding:5px;cursor:pointer">Parts Ordered</li>
  	<li onclick="document.body.onunload='';document.theform.action='savero.asp?comid=<%=comrs("complaintid")%>&comstat=Assembly';saveAll('ro.asp?a=n','','','','','')" onmouseout="this.style.backgroundColor='silver';this.style.color='black'" onmouseover="this.style.backgroundColor='green';this.style.color='white'" style="padding:5px;cursor:pointer">Assembly</li>
  	<li onclick="document.body.onunload='';document.theform.action='savero.asp?comid=<%=comrs("complaintid")%>&comstat=Job Complete';saveAll('ro.asp?a=n','','','','','')" onmouseout="this.style.backgroundColor='silver';this.style.color='black'" onmouseover="this.style.backgroundColor='green';this.style.color='white'" style="padding:5px;cursor:pointer">Job Complete</li>
  	<li onclick="document.body.onunload='';deleteVehIssue('<%=comrs("complaintid")%>');" onmouseout="this.style.backgroundColor='silver';this.style.color='black'" onmouseover="this.style.backgroundColor='green';this.style.color='white'" style="padding:5px;cursor:pointer">Delete Issue</li>
  	<li onclick="document.getElementById('drop<%=comrs("complaintid")%>').style.display='none'" onmouseout="this.style.backgroundColor='silver';this.style.color='black'" onmouseover="this.style.backgroundColor='green';this.style.color='white'" style="padding:5px;cursor:pointer;font-size:x-small">Close This</li>
  </ul>
  <%
  	case "Pending"
  %>
  <ul id="drop<%=comrs("complaintid")%>" style="list-style-type:none;display:none;position:absolute;width:130px;background-color:silver;z-index:1001;font-weight:bold; left: 0px; top: 0px; padding:5px;border:thin gray solid" id="test">
    <li onclick="declineItem('<%=comrs("complaintid")%>')" onmouseout="this.style.backgroundColor='silver';this.style.color='black'" onmouseover="this.style.backgroundColor='green';this.style.color='white'" style="padding:5px;cursor:pointer">Declined</li>
  	<li onclick="document.body.onunload='';document.theform.action='savero.asp?comid=<%=comrs("complaintid")%>&comstat=Approved';saveAll('ro.asp?a=n','','','','','')" onmouseout="this.style.backgroundColor='silver';this.style.color='black'" onmouseover="this.style.backgroundColor='green';this.style.color='white'" style="padding:5px;cursor:pointer">Approved</li>
  	<li onclick="document.body.onunload='';document.theform.action='savero.asp?comid=<%=comrs("complaintid")%>&comstat=Parts Ordered';saveAll('ro.asp?a=n','','','','','')" onmouseout="this.style.backgroundColor='silver';this.style.color='black'" onmouseover="this.style.backgroundColor='green';this.style.color='white'" style="padding:5px;cursor:pointer">Parts Ordered</li>
  	<li onclick="document.body.onunload='';document.theform.action='savero.asp?comid=<%=comrs("complaintid")%>&comstat=Assembly';saveAll('ro.asp?a=n','','','','','')" onmouseout="this.style.backgroundColor='silver';this.style.color='black'" onmouseover="this.style.backgroundColor='green';this.style.color='white'" style="padding:5px;cursor:pointer">Assembly</li>
  	<li onclick="document.body.onunload='';document.theform.action='savero.asp?comid=<%=comrs("complaintid")%>&comstat=Job Complete';saveAll('ro.asp?a=n','','','','','')" onmouseout="this.style.backgroundColor='silver';this.style.color='black'" onmouseover="this.style.backgroundColor='green';this.style.color='white'" style="padding:5px;cursor:pointer">Job Complete</li>
  	<li onclick="document.body.onunload='';deleteVehIssue('<%=comrs("complaintid")%>');" onmouseout="this.style.backgroundColor='silver';this.style.color='black'" onmouseover="this.style.backgroundColor='green';this.style.color='white'" style="padding:5px;cursor:pointer">Delete Issue</li>
  ...
  <%while not crs.eof%>
  <tr>
    <td width="19%"><font size="1"><b>(P)</b> <%=trim(crs("partnumber"))%>&nbsp;</font></td>
    ...
    <td width="5%" align="center"><font size="1"><a href="javascript:document.body.onunload='';saveAll('editpart.asp?','part','','<%=crs("PartID")%>','')"><img border=0 src=newimages/edit2.png width=16 height=17></a></font><a onmouseover="javascript:status='Delete Part';return true" onmouseout="javascript:status='Shop Boss Pro';return true" href="javascript:document.body.onunload='';conDel('delroitem.asp?','part','','<%=crs("PartID")%>','')"><img border="0" src="newimages/delete.png" width="16" height="17"></a> </td>
  </tr>
  <%
  ...
  'get labor
  cstmt = "select * from labor where shopid = '" & request.cookies("shopid") & "' and roid = " & roid & " and complaintid = " & comid
  set crs = con.execute(cstmt)
  if crs.eof then
 ...
 <!-- parts ends, labor begins -->
  ...
  <%
    ...
    mypos = instr(crs("Tech"), ",")
        if mypos = 0 then
          'get employee
          posstmt = "select employeelast from employees where shopid = '" & request.cookies("shopid") & "' and employeeid = " & cint(crs("Tech"))
        ...
        stmt = "select * from labortimeclock where shopid = '" & request.cookies("shopid") & "' and roid = " & request("roid") & " and complaintid = " _
  ...
  %>
  <tr>
    <td valign="top" width="19%"><font size="1"><b>(L)</b> <%=thetech%>&nbsp;
    <%
    if ttlclockdiff > 0 then
    %>
    ...
    <td width="5%" valign="top" align="center"><font size="1"><a href="javascript:document.body.onunload='';saveAll('editlabor.asp?','labor','','','<%=crs("LaborID")%>')"><img border=0 src=newimages/edit2.png width=16 height=17></a></font><a onmouseover="javascript:status='Delete Labor Item';return true" onmouseout="javascript:status='Shop Boss Pro';return true" href="javascript:document.body.onunload='';conDel('delroitem.asp?','labor','','','<%=crs("LaborID")%>')"><img border="0" src="newimages/delete.png" width="16" height="17"></a></td>
  </tr>
  <%
  ...
  'get sublet
  cstmt = "select * from sublet where deleted = 'no' and shopid = '" & request.cookies("shopid") & "' and roid = " & roid & " and complaintid = " & comid
  set crs = con.execute(cstmt)
  if crs.eof then
