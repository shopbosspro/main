...
if len(request("cc")) > 0 then
	...
	if lcase(request("radio1")) = "silver" then
		flatprice = "99.00"
	elseif lcase(request("radio1")) = "gold" then
		flatprice = "159.00"
	elseif lcase(request("radio1")) = "platinum" then
		flatprice = "259.00"
	end if

	stmt = "update company set newpackagetype = '" & request("radio1") & "', flatprice = " & flatprice & ", blastname = '" & request("blastname") & "', bfirstname = '" & request("bfirstname") & "', howpaying = 'cc'" _
...
function checkForm(){
	...
	if(!$("input[name='Radio1']:checked").val()){
		alert("Please select your desired package below (Gold, Silver or Platinum)")
		return
	}
...
<br/><span class="style6"><strong>You have reached the end of your Trial 
	Account.&nbsp; To activate your account, please update your credit card or bank 
	account information below</strong></span><br/>
...
<table cellpadding="6" cellspacing="0" style="width: 100%">
	<tr>
		<td style="width: 50%; ">
<form action="activatetrialaccount-new.asp" name="bankform" method="post">
...
<input name="shopid" value="<%=request("shopid")%>" type="hidden" />
	...
	<table style="width: 100%">
		<tr>
			...
			continue to use Shop Boss, please complete the information below.<br />
			<br />
...
<input name="billingzip" value=''  type="text" class="style5" style="width: 104px" /></td>
	...
	<span class="style5">Please select your desired package.</span><br />
<p class="style3"><span class="style5">
<strong><input name="Radio1" type="radio" value="silver" /> Silver Package: $99.00 per month - </strong>Includes full access to the Shop Boss 
application with all standard features.&nbsp; Does not include Integrated Parts 
Ordering or the MOTOR Labor Guide<strong>.<br />
<br />
<input name="Radio1" type="radio" value="gold" /> Gold Package: $159.00 per month</strong> - Includes full access to the Shop Boss application with 
all standard features plus Integrated Parts Ordering with Epicor, Nexpart and 
WorldPac.&nbsp; Also include MOTOR Estimating Guide with Labor times and OEM 
Parts Prices.&nbsp;</span><br class="style5" />
<br class="style5" />
<span class="style5">
<strong><input name="Radio1" type="radio" value="platinum" /> Platinum Package: 
$259.00 per month</strong> - All Features of Gold Package plus full MOTOR 
Repair Guide (which includes Repair Procedures and Images, Diagrams, DTC's, 
TSB's, Scheduled Maintenance, Specifications, Alignment Specifications and much 
more.&nbsp;</span><br class="style5" />
			</p>
